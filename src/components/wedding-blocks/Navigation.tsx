...
export function Navigation({ palette, fonts, layout, partner1name, partner2name }: NavigationProps) {
  ...
  return (
    <div className="absolute top-0 left-0 right-0 z-50">
      <div className="w-full" style={{ paddingTop: '16px', paddingBottom: '12px', paddingLeft: '16px', paddingRight: '16px', marginRight: '200px' }}>
          ...
          <div className="flex items-center justify-end">
            {hasRSVP && (
              <button
                ...
                className="px-3 py-1 transition-all duration-300 hover:scale-105 hover:shadow-lg relative"
                style={{
                  fontFamily: fonts.body,
                  color: '#ffffff',
